...
seqs = ["AUGGCUACUUUCG", "ACGUACGUAU"]

labels, X  = NNFeatures.extract(100, sequences=seqs)   # MP-RNA sequence-level
labels, Xt = NNFeatures.extract(101, sequences=seqs)   # MP-RNA per-token
labels, Xc = NNFeatures.extract(130, sequences=seqs)   # MP-RNA chunked

labels, Ya  = NNFeatures.extract(103, sequences=seqs)  # AIDO sequence-level
labels, Yat = NNFeatures.extract(104, sequences=seqs)  # AIDO per-token
labels, Yac = NNFeatures.extract(131, sequences=seqs)  # AIDO chunked
