...
def calculat_GIP_lncRNA(matrix ): 
...
def main (): 
    ...
    print("\nGIP kernel similarity between lncRNAs:")
    df_gip_lnc = calculat_GIP_lncRNA(A)
    print(df_gip_lnc)

    
    df_gip_dis = calculat_GIP_DIS(A)
    print("\nGIP kernel similarity between diseases:")
    print(df_gip_dis) 
